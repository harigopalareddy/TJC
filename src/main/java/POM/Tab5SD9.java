...
public class Tab5SD9 extends LoginAndStart  {
	...
	public static void tab5SD9() {
		WebDriverWait wait=new WebDriverWait(driver,Duration.ofSeconds(20));
		driver.findElement(sitename).clear();
		driver.findElement(sitename).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(sitename).sendKeys("Test9");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(dobussas).clear();
		driver.findElement(dobussas).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(dobussas).sendKeys("test9");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		...
		driver.findElement(zipcode).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		driver.findElement(zipcode).sendKeys("60138"+Keys.ENTER);
