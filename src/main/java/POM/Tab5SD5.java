...
public class Tab5SD5 extends LoginAndStart {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(sitename).sendKeys("Test5");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		driver.findElement(dobussas).clear();
		driver.findElement(dobussas).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		driver.findElement(dobussas).sendKeys("test5");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		driver.findElement(SSA).clear();
		driver.findElement(SSA).clear();
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		driver.findElement(SSA).sendKeys("fifth Street");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
